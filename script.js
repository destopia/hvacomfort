    ...
    plotlyDiv.on('plotly_click', function (data) {
      ...
      const renderSelectedMetric = () => {
        ...
        Plotly.newPlot("zoneGraph", [trace], {
          ...
          xaxis: { title: "Hour", tickmode: "array", tickvals: [...Array(24).keys()], ticktext: [...Array(24).keys()] },
          yaxis: { title: selectedMetric.toUpperCase() },
          margin: { t: 40, l: 30, r: 20, b: 40 },
          paper_bgcolor: 'rgba(0,0,0,0)', plot_bgcolor: 'rgba(0,0,0,0)',
          autosize: true,
          shapes: [thresholdLine], annotations: [thresholdAnnotation]
        });
